    ...
    return (
      <div>
        <div className="page-hero">
          ...
          <p className="sub-tagline">Whether you're a photographer, designer, tastemaker, or just want to share your ideas. Curator-rater is there to help you find your audience.</p>
